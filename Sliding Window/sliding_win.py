...
def write_coords(list, img='LC80460222014219LGN00_testhelen'):
    print len(list)
    import csv
...
def control(img="FFLC80460222014219LGN00"):
    im = 'E:\Fracking Data\RGB Scenes Ready for Site-Lifting/%s.tif' % img
    batch = 1024
    batchx = 16
    batchy = 64
