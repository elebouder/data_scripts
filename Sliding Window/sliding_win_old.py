    ...
    def net_io_control(self):
        while self.keepgoing:
            ...
            if datum is None:
                ...
                write_coords(self.hitlist, self.count)
                break
...
def write_coords(list, count, img='FFLC80470202015133LGN00'):
...
def control(img="FFLC80470202015133LGN00"):
